    ...
    <header className="sticky top-0 z-20 h-18 bg-slate-900/90 backdrop-blur-md border-b border-slate-800 px-4 sm:px-8 flex items-center justify-between shadow-xs">
      ...
      <div className="hidden lg:flex items-center max-w-md w-full mx-6">
        <div className="relative w-full">
          ...
          <input
            ...
            className="w-full bg-slate-950/80 border border-slate-800 rounded-xl pl-10 pr-12 py-2 text-xs text-slate-100 placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all"
          />
          <div className="absolute inset-y-0 right-0 pr-2.5 flex items-center">
            <kbd className="hidden sm:inline-block px-1.5 py-0.5 text-[10px] font-semibold text-slate-400 bg-slate-800 border border-slate-700 rounded shadow-2xs">
              ⌘K
            </kbd>
          </div>
        </div>
      ...
      <div className="flex items-center gap-2.5 sm:gap-4">
        ...
        <button
          ...
          className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-xl bg-indigo-950/80 hover:bg-indigo-900 text-indigo-300 border border-indigo-800/80 text-xs font-semibold transition-all shadow-2xs group"
        >
        ...
        {/* Streak Indicator */}
        <div className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl bg-amber-950/60 border border-amber-800/80 text-amber-300 text-xs font-bold shadow-2xs">
        ...
        <div className="relative">
          ...
          {showNotifications && (
            <div className="absolute right-0 mt-3 w-80 sm:w-96 cyber-glass rounded-2xl shadow-2xl border border-slate-800 p-4 animate-slide-down z-50">
              ...
              <div className="divide-y divide-slate-800/80 max-h-72 overflow-y-auto mt-2 space-y-1">
                {mockNotifications.map((notif) => (
                  <div
                    ...
                    className="py-2.5 px-2 rounded-xl hover:bg-slate-800/60 transition-colors cursor-pointer text-left"
                  >
        ...
        >
          <img
            ...
            className="w-8 h-8 rounded-xl object-cover ring-2 ring-slate-700 group-hover:ring-cyan-400 transition-all"
          />
        </div>
      </div>
    </header>
