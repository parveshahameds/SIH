...
export const StudentHeader: React.FC<StudentHeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-20 h-18 bg-white/95 backdrop-blur-md border-b border-slate-200 px-4 sm:px-8 flex items-center justify-between shadow-xs">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-base sm:text-lg font-bold text-slate-900 capitalize font-sans tracking-tight">
      ...
      <div className="hidden lg:flex items-center max-w-md w-full mx-6">
        <div className="relative w-full">
          ...
          <input
            ...
            className="w-full bg-slate-50 border border-slate-300 rounded-xl pl-10 pr-12 py-2 text-xs text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all"
          />
      ...
      <div className="flex items-center gap-2.5 sm:gap-4">
        ...
        <button
          ...
          className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-xl bg-indigo-50 hover:bg-indigo-100 text-indigo-700 border border-indigo-200 text-xs font-semibold transition-all shadow-2xs group"
        >
        ...
        {/* Streak Indicator */}
        <div className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl bg-amber-50 border border-amber-200 text-amber-800 text-xs font-bold shadow-2xs">
        ...
        <div className="relative">
          ...
          {showNotifications && (
            <div className="absolute right-0 mt-3 w-80 sm:w-96 bg-white rounded-2xl shadow-xl border border-slate-200 p-4 animate-slide-down z-50">
        ...
        >
          <img
            ...
            className="w-8 h-8 rounded-xl object-cover ring-2 ring-slate-200 group-hover:ring-indigo-500 transition-all shadow-xs"
          />
        </div>
      </div>
    </header>
